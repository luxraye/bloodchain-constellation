...
function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-200">
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col overflow-hidden border-x border-slate-300 bg-slate-50 text-slate-900 shadow-xl">
        <Navbar profileName={profile?.name} />
        <DesktopTabStrip activeTab={activeTab} onChange={setActiveTab} />
        <main className="relative flex-1 overflow-y-auto overflow-x-hidden p-4 pb-24 lg:px-10 lg:pb-8">
...
function LoginScreen() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-200">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col overflow-y-auto border-x border-slate-300 bg-gradient-to-br from-slate-50 via-slate-100 to-slate-200 px-5 py-10 shadow-xl sm:px-10 lg:px-16 lg:py-16">
        ...
        <div className="relative z-10 rounded-3xl border border-white/60 bg-white/60 p-6 backdrop-blur-xl shadow-soft-card">
          {magicSent ? (
            ...
            <p className="mt-6 text-center text-[11px] text-slate-400 lg:text-left">Bloodchain Botswana · National Blood Transfusion Service</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="rounded-2xl bg-slate-900 p-4 text-slate-50 shadow-soft-card">
        ...
        <p className="text-base font-semibold">
          ...
          <span className="font-bold">
            {formatLocalDate(profile.nextEligibleDate) ?? 'See your deferral notice or contact NBTS'}
          </span>
        </p>
...
function DesktopTabStrip({ activeTab, onChange }) {
  ...
  return (
    <nav className="hidden shrink-0 border-b border-slate-200 bg-white px-6 py-2 lg:block lg:px-10">
...
function BottomNav({ activeTab, onChange }) {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-10 border-t border-slate-200 bg-white/90 backdrop-blur-md lg:hidden">
