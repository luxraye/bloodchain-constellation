    ...
    <section id="contact" className="relative border-t border-white/6 py-20">
      ...
      <div className="mx-auto max-w-3xl px-6">
        ...
        <p className="mx-auto mb-10 max-w-md text-center text-sm leading-relaxed text-slate-400">
          ...
          <span className="font-semibold text-slate-200">{SITE.contactName}</span> to arrange a guided walkthrough or
          discuss a pilot.
        </p>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-center">
          <a
            href={mailtoGeneral()}
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-rose-600 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-rose-900/40 transition hover:bg-rose-500"
          >
            General enquiry
          </a>
          <a
            href={mailtoCollaboration()}
            className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-semibold text-slate-200 transition hover:border-white/20 hover:bg-white/10"
          >
            Partnership / pilot
          </a>
          <a
