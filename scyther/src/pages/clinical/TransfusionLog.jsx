...
export default function TransfusionLog() {
    ...
    const handleSimulatePatient = () => {
        addNotification('Patient simulation is disabled in pilot mode', 'info');
    };
    ...
    const handleSimulateUnit = () => {
        addNotification('Unit simulation is disabled in pilot mode', 'info');
    };
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div className={`card p-6 ${flashType === 'green' && !unit ? 'flash-green' : flashType === 'red' && !unit ? 'flash-red' : ''}`}>
                    ...
                    <div className="mt-2 text-xs text-slate-400">
                        Patient IDs must come from your live patient source
                    </div>
                </div>
