...
export default function LoginScreen() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-slate-900 px-4 py-12">
      <div className="mx-auto w-full max-w-md rounded-xl border border-slate-700 bg-slate-800/80 p-8 shadow-xl sm:max-w-lg sm:p-10">
        {/* Logo */}
